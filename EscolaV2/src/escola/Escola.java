...
public class Escola {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < t.tamanho(); i++){
            ...
            //System.out.println((Aluno)(t.lista.get(i)).getNome());
            //System.out.println((Pessoa)(t.lista.get(i))).getNome();
            //System.out.print(((Pessoa)(t.lista.get(i))).getNome());
            //System.out.println(" - " + ((Pessoa)(t.lista.get(i))).getIdade());
            //((Pessoa) t.lista.get(i)).getNome();
            //System.out.println(((Pessoa) t.lista.get(i)).getNome());
            //System.out.println(((Pessoa) t.lista.get(i)).getIdade());
            
            System.out.println(((Pessoa) t.lista.get(i)).toString());
        }*/
